...
<div class="login w990 bc mt10 regist">
    ...
    <div class="login_bd">
        <div class="login_form fl">
            <form action="index.php?r=member/add" method="post" id="signupForm">
                <ul>
                    <li>
                        <label for="">用户名：</label>
                    ...
                    <li class="checkcode">
                        ...
                        <img id="img_captcha" src="<?=\yii\helpers\Url::to(['member/captcha'])?>" alt="" />
        ...
        $("#signupForm").validate({
            rules: {
                username: {
                    ...
                    minlength: 2,
                    remote:{
                        url:"<?=\yii\helpers\Url::to(['member/validate-user'])?>",
