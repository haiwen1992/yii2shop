    ...
    <div class="content fl ml10">
        <div class="address_hd">
            ...
            <?php foreach($model as $models):?>
                <dl id="dl">
                    <dt><?=$models->id?>.<?=$models->name?>:<?=$models->cmbprovince?><?=$models->cmbcity?><?=$models->cmbarea?>  手机:<?=$models->phone?></dt>
                    <dd>
                        <a href="<?=\yii\helpers\Url::to(['address/edit','id'=>$models->id])?>">修改</a>
<!--                        <a href="--><?//=\yii\helpers\Url::to(['address/delete','id'=>$models->id])?><!--" id="delete">删除</a>-->
...
$js=<<<JS
   $("#dl").on('click','#delete',function(){
       var dl = $(this).closest('dl');
       if(confirm('删除!!!请再次确认')){
            $.get("$url",{id:dl.attr('id')},function(){
              dl.remove();
           });
       }
