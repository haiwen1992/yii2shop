...
<div class="main w1210 bc mt10">
    ...
    <div class="address_bd mt10">
        <h4>新增收货地址</h4>
        <form action="<?=\yii\helpers\Url::to(['address/edit'])?>"  method="post">
            ...
            <ul>
                ...
                <li>
                    ...
                    <select id="cmbProvince" name="cmbprovince" value="<?=$model['cmbprovince']?>"></select>
                    <select id="cmbCity" name="cmbcity" value="<?=$model['cmbcity']?>"></select>
                    <select id="cmbArea" name="cmbarea" value="<?=$model['cmbarea']?>"></select>
                ...
                <li>
                    ...
                    <input type="text" name="detailed" value="<?=$model['detailed']?>" class="txt address"  />
                </li>
                <li>
                    <label for=""><span>*</span>手机号码：</label>
                    <input type="text" name="phone" value="<?=$model['phone']?>"  class="txt" />
                </li>
                <li>
                    <label for="">&nbsp;</label>
                    <input type="checkbox" name="default" value="<?=$model['default']?>" class="check" />设为默认地址
                </li>
                <li>
                    <label for="">&nbsp;</label>
